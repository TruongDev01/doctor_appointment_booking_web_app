...
export default function BookAppointment({ doctor }) {
    ...
    const getTime = () => {
        const timeList = [];
        // Tạo danh sách thời gian buổi sáng (AM)
        for (let i = 10; i <= 12; i++) {
            timeList.push({
                time: i + ':00 AM'
            });
        ...
        // Tạo danh sách thời gian buổi chiều (PM)
        for (let i = 1; i <= 6; i++) {
            timeList.push({
                time: i + ':00 PM'
            });
    ...
    const saveBooking = () => {
        ...
        GlobalApi.bookAppointment(data).then(resp => {
            ...
            if (resp) {
                ...
                toast("Booking Confirmation will sent on Email ")
        ...
        <Dialog>
            ...
            <DialogContent>
                ...
                <DialogFooter className="sm:justify-end">
                    <DialogClose asChild>
                        <>
                            <Button className='text-red-500 border-red-500'
